...
document.addEventListener("DOMContentLoaded", () => {
    ...
    //let chat1 = new chat('-1','chat','img/newGroupImg.svg',[Ricardo,Lucas,Zeulo,Alice],null,[Zeulo]);
})
let callSounds = [
...
/*const Lucas = new Aluno('Lucas', 'Blanes', 'img/user.svg', 'lucas.blanes@colegiodante.org.br', '5°', '18', 'F', 'E. Fund.1');
const Ricardo = new Aluno('Ricardo', 'Eloy', 'img/user.svg', 'ricardo.eloy@colegiodante.org.br', '2°', '2', 'G', 'E. Medio');
const Alice = new Aluno('Alice', 'Opressora', 'img/user.svg', 'alice.kwai@colegiodante.org.br', '1°', '8', 'G', 'E. Medio');*/
const alunos = []
for (let i = 0; i < 4; i++) { //get in database
    alunos.push(new Aluno('name' + i, 'last_name', 'img/user.svg', 'nome.sobrenome@colegiodante.org.br', 'ano', 'n°', 'turma', 'ensino'))
}
...
class chat {
    ...
    addGuestMenu() {
        ...
        this.addNewGuestTitle.style.borderBottom = '2px solid';
