...
class chat {
    ...
    addGuestMenu() {
        ...
        //closeNewGuestMenu
        this.closeNewGuestMenu = document.createElement('span');
        this.closeNewGuestMenu.classList.add('material-symbols-outlined','btn');
        this.closeNewGuestMenu.innerText = 'close';
        this.closeNewGuestMenu.style.position = 'absolute';
        this.closeNewGuestMenu.style.padding = '10px';
        this.closeNewGuestMenu.onclick = () => {
            this.newGuestMenu.style.display = 'none';
        }
        this.newGuestMenu.appendChild(this.closeNewGuestMenu);
                ...
                if(this.file.type !== "text/html" && this.file.type.startsWith('text/') || this.file.name.slice(-3) == '.md' || this.file.name.slice(-4) == '.jem') {
                    ...
                    reader.onload = (e) => {
                        if(this.file.type.startsWith('image/')) {
                            ...
                            //loop
                            this.audioLoop = document.createElement('span');
                            this.audioLoop.title = 'loop';
                            this.audioLoop.classList.add('material-symbols-outlined','btn');
                            this.audioLoop.innerText = 'repeat_one';
                            this.audioContextMenu.appendChild(this.audioLoop);
                            //play/pause
