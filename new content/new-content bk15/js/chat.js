...
document.addEventListener("DOMContentLoaded", function() {
    ...
    if ('deviceMemory' in navigator) {
        ...
        document.getElementById("ram-display").innerText = 'Ram:'+ ramAmount + 'GB';
    } else {
    ...
    if ('connection' in navigator) {
        ...
        document.getElementById('internet-display').innerText = 'internet do tipo 4g';
        } else if (connectionType === '3g' && downloadSpeed > 2) {
        console.log('3g detectado');
        document.getElementById('internet-display').innerText = 'internet do tipo 3g';
        } else {
        console.log('2g detectado');
        document.getElementById('internet-display').innerText = 'internet do tipo 2g';
        }
    } else {
...
function send() {
    ...
    if (document.getElementById("ur-msg").value !== "" && textenvspace !== "") {
        ...
        if (dropzone.style.display == "none") {
            dropzone.style.display = "block";//urmsg
            imgPreview.src = "";
