...
document.addEventListener("DOMContentLoaded", function() {
    ...
    if (userAgent.match(/(Chrome|Chromium)\//i)) {
        navname.innerText = 'Chrome';
        navimg.src = 'img/web/chrome-svgrepo-com.svg';
        navimg.style.width = '40px';
    } else  if (userAgent.match(/Firefox\//i)) {
        navname.innerText = 'Firefox';
        navimg.src = 'img/web/firefox-svgrepo-com.svg';
        navimg.style.width = '40px';
    } else if (userAgent.match(/Safari\//i)) {
        navname.innerText = 'Safari';
        navimg.src = 'img/web/safari-color-svgrepo-com.svg';
        navimg.style.width = '40px';
    } else if (userAgent.match(/Edg(e|A|iOS)\//i)) {
        navname.innerText = 'Edge';
        navimg.src = 'img/web/edge-svgrepo-com.svg';
        navimg.style.width = '40px';
    } else if (userAgent.match(/Opera|OPR\//i)) {
        navname.innerText = 'Opera';
        navimg.src = 'img/web/opera-gx-svgrepo-com.svg';
        navimg.style.width = '40px';
    } else if (userAgent.match(/UCBrowser\//i)) {
        navname.innerText = 'UC';
        navimg.src = 'img/web/uc-svgrepo-com.svg';
        navimg.style.width = '40px';
    } else if (userAgent.match(/Vivaldi\//i)) {
        navname.innerText = 'Vivaldi';
        navimg.src = 'img/web/vivaldi-icon-svgrepo-com.svg';
        navimg.style.width = '40px';
    } else if (userAgent.match(/Brave\//i)) {
        navname.innerText = 'Brave';
        navimg.src = 'img/web/brave-svgrepo-com.svg';
        navimg.style.width = '40px';
    } else if (userAgent.match(/SamsungBrowser\//i)) {
        navname.innerText = 'Samsung';
        navimg.src = 'img/web/samsung-internet-svgrepo-com.svg';
        navimg.style.width = '40px';
    } else {
        document.getElementById('navigator-name').innerText = '[não listado]';
    }*/
    //ram
    ...
    if ('connection' in navigator) {
        ...
        document.getElementById('internet-display').innerText = '2G';
        }
    } else {
...
function configs() {
    ...
    const cfgbtn = document.getElementById("configinbutton");
...
function send() {
    ...
    if (document.getElementById("ur-msg").value !== "" && textenvspace !== "") {
        ...
        if (textarea.style.display == "none") {
            textarea.style.display = "block";//urmsg
            imgPreview.src = "";
