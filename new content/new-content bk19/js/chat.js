...
let ldpalavrões = {
    "A":["a","@","∀","Α","α","Δ","∆","Λ","λ","Ἃ","Ἇ","ά","ᾰ","Ᾰ","Ά","₳"],
    "B":["b","฿","₿","Β","β"],
    "C":["c","ç","©","℃","Ⅽ","ↅ","Ↄ","ⅽ","⊑","⊂","⊏","⊐","⊉","⊆","⊇","⊊","⊋","∁","ↄ","Ↄ","⊈","⋤","⋥","ς","₡","¢","₠"],
    "D":["d","Ⅾ","Đ","Ð","đ","₫"],
    "E":["e","£","3","Ɛ","∃","∄","∈","∋","Ě","Ĕ","&","⋻","⋸","⋵","⋲","⋳","⋶","⋹","⋿","Ε","ε","Ἓ","Ἕ","ὲ","έ","Έ","έ","Σ","϶","ϵ","ξ","₠","€"],
    "F":["f","℉","₣"],
    "G":["g","Ĝ","Ğ","Ģ"],
    "H":["h","Ħ","ħ","ɧ","ɦ","Η"],
    "I":["i","!","1","l","|","ⅾ","¡","Ι","ι","ⅰ","ⅼ","Ⅰ","∣"],
    ...
    'M':["m","w","Ⅿ","ⅿ","ɱ","Σ","Μ"],
    'N':["n","Ν","₦","η"],
    'O':["O","o","0","◯","⊘","⊙","⊖","⊜","⊛","⊕","⨀","⨁","Ø","Ο","ο","ϴ","Ὸ","Ό","ὁ","Ὁ","Φ","σ","φ","ὄ","Ὄ","Ὂ","ὂ"],
    'P':["P","p","℗","₱","₽","Ρ","ρ"],
    'Q':["Q","Q","Ø","φ","Φ"],
    'R':["R","r","Π","π","®","Γ"],
    'S':["s","§","₷","₴","$"],
...
function intext() {
    let palavroes = ldpalavrões['O'];
    if (palavroes.includes(textarea.value)) {
        console.log('ok');
    } else {
        console.log('n');
    }
