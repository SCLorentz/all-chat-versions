...
function createagroup() {
    ...
    groupconfigs.style.position = "fixed";
    groupconfigs.style.right = "3%";
    groupconfigs.style.cursor = "pointer";
    groupconfigs.style.userSelect = "none";
    groupconfigsA.onclick=function() {
